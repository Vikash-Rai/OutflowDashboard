...
import BatchTableRow from 'src/sections/@dashboard/e-commerce/product-list/BatchTableRow';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'batch', label: 'Batch ID', align: 'left' },
  { id: 'createdAt', label: 'Created at', align: 'left' },
  { id: 'status', label: 'Status', align: 'center', width: 180 },
  { id: 'price', label: 'Containers', align: 'right' },
];
